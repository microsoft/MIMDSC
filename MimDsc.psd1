...
GUID = '8db4b80b-2aa4-420d-9882-d7bd95eac96b'
...
FunctionsToExport = @(
    ...
    'Convert-MimSyncPrecedenceToCimInstance'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        LicenseUri = 'https://github.com/Microsoft/MIMDSC/blob/master/LICENSE'

        # A URL to the main website for this project.
        ProjectUri = 'https://github.com/Microsoft/MIMDSC'

        # A URL to an icon representing this module.
        # IconUri = ''

        # ReleaseNotes of this module
        ReleaseNotes = '-Test versioning
        UTF8
'
